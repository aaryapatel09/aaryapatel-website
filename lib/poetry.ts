export const poetryContent: Record<string, string> = {
  'how-to-live-inside-a-wire': `in the city, i learned how to breathe around metal: exhale the hum of fluorescent lights and choke on the buzz of the power lines.
...
on the pieces of us we left behind.`,
  ...
  'the-last-human-poet': `They taught the machine to write sonnets
...
of being.`,
  ...
  'the-music-teachers-final-lesson': `The replacement doesn't sweat
...
to say what words cannot.`,
  ...
  'gallery-opening-humans-not-included': `The walls exhale algorithms
...
save anyone's life.`,
  ...
  'archaeology-of-creativity': `In the Museum of Extinct Human Practices,
...
with their bodies.`,
  ...
  'the-curator-of-extinct-emotions': `I catalog feelings
...
of our algorithms.`,
  ...
  'the-last-brushstroke': `My hand shakes
